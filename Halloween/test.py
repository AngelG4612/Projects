...
video1 = ["omxplayer", "filename", "-o", "both", "--win", "0 0 1920x1080", "--aspect-mode", "fill", "--no-osd", "--orientation", "180","--vol", "-600"]
...
def getFileName():
    return "/home/pi/Projects/Halloween/Recordings/" + datetime.datetime.now().strftime("%H.%M.%S.mp4")
...
#         video1[1] = autoFileName
#         subProcWait(video1)  # Play back the video we just recorded
